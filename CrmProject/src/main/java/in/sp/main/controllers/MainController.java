...
public class MainController 
{
	...
	//LOGIN FORM TO GO WITH VALUE USE @RequestParam email and password
	...
	{
		String page = "login";
		if(myemail.equals("adminamit@gmail.com") && mypass.equals("adminamit123"))
		{
			page = "profile-admin";//if email id and pass correct then this page will be open 
		}
		else
		{
	...
	@PostMapping("/addEmpForm")//to register employee ....entity claass is employee 
